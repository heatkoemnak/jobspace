...
export default function TopBar() {
  return (
    <>
      <header className="flex mx-5 justify-between items-center">
        <div className="search">
          <SearchInput />
        </div>
        <button
          type="button"
          className="flex items-center gap-2 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-full text-sm lg:text-base mx-3 px-2 lg:px-3 py-1"
        >
